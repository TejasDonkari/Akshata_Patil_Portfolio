      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-start md:items-center gap-12 w-full">
        ...
        <div className="md:w-1/2 w-full flex flex-col justify-start text-left space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-start">
            <a
              href="#projects"
              className="inline-flex items-center justify-center px-6 py-3 text-base font-medium rounded-md text-white bg-cyan-600 hover:bg-cyan-700 transition-all shadow-lg shadow-cyan-500/30"
            >
              View My Work
